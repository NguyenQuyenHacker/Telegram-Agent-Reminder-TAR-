...
Nhánh nạp KHÔNG gọi LLM. Chi phí của graph này là vài lượt ghi checkpoint, đổi
lại có điểm dừng chờ admin bấm và resume được sau khi app restart.
"""

from langgraph.checkpoint.base import BaseCheckpointSaver
from langgraph.graph import END, START, StateGraph

from TAR_agent.graph_admin.nodes import ask_project, check_file, handle_text, parse, report, route
...
def build_admin_graph(checkpointer: BaseCheckpointSaver):
    ...
    builder.add_conditional_edges(
        "parse", after_parse, {"store": "store", "report": "report"}
    )
